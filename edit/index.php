...
<body>
	<form class="" action="" method="post">
		<div class="wrapper">
			...
			?>
			<input id="input" type="number" name="<?php echo $CSmiirl->getJsonKey(); ?>" value="<?php
			echo $CSmiirl->getDefaultInputValue(); ?>" placeholder="<?php echo $CSmiirl->getFirstAction()[HTML_INPUT]; ?>" required>
			<span class="underline"></span>
			<input id="submit" type="submit" value="<?php echo reset($_ACTIONS)[HTML_SUBMIT]; ?>">
		</div>
		<div class="pin">
			<?php
			echo $CSmiirl->getDefaultTitleLog();
			?>
		</div>
	...
	<?php
	if ( $_ACTIVE_EASTER_EGGS ) { include '../template/easter-egg.php';}
	?>
	<audio id="audio">
